...
public class InformationRetrievalParserArabic implements InformationRetrievalParser {
    ...
    public InformationRetrievalParserArabic(ParsingDocument parsing_document, Integer buffer_size) throws Exception {
    ...
    public ArrayList<Word> getNextWords(Reader document_reader) throws Exception {        
        ...
        for (int c = 0; c < buffer_last_read_length; c++) {
            ...
            //String unicode = "\\u"+Integer.toHexString(token | 0x10000).substring(1);
